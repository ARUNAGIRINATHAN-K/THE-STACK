...
- [Tracefold](https://github.com/TraceFold/tracefold) `🚀` `[Rust]` `[MCP]` - Verified reverse-execution gateway and drop-in MCP wrapper that escrows pre-commit inverses, enforces Cedar policy gates, and produces signed DSSE receipts for tool mutations.
